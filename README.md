[OpenImgur](https://Opengurthub.io/OpenImgur/)
=========
...
#What's New
Check the [Changelog](https://github.com/skunkkhole/OpenImgur/blob/main/CHANGELOG.MD) for the changes of each version
